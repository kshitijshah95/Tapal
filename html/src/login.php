...
$bg="background-image: url('../images/loginbg.jpg');
    background-repeat: no-repeat; background-size:100%;";
displayHtmlHeader( "$org_name - " . _("Login"), $header, FALSE );

echo "<body text=\"$color[8]\" style=\"$bg\" background='../images/loginbg.jpg' link=\"$color[7]\" vlink=\"$color[7]\" alink=\"$color[7]\" onLoad=\"squirrelmail_loginpage_onload();\">" .
...
echo html_tag( 'table style="background-color:transparent; margin-left:350px; margin-top:350px;"',
    html_tag( 'tr',
        html_tag( 'td',
            '<center>'.
            ( isset($org_logo) && $org_logo
              ? '<img style="position:absolute; top:225px; left:43%;" src="' . $org_logo . '" alt="' .
            ...
            "\n".
            '' . _() . "\n" ) .
            html_tag('strong style="font-size:20px;" ',
              "WELCOME. Please Login."
              ).
            html_tag( 'table style="background-color:transparent;"',
                html_tag( 'tr',
                    html_tag( 'td style="background-color:transparent;"',  "\n" .
                        html_tag( 'table style="background-color:transparent; font-size:20px;" ',
                            html_tag( 'tr',
                                html_tag( 'td',
                                    _("") ,
                                'right', '', 'width="30%"' ) .
                                html_tag( 'td',
            addInput($username_form_name, $loginname_value, 0, 0, 'onfocus="alreadyFocused=true;"  style="background-color: #e5e5e5;
border: none;
border-radius: 3px;
...
box-shadow: 0 0 3px 3px #663300;"'),
                            ...
                            html_tag( 'tr',
                                ...
                                'right', '', 'width="30%"' ) .
                                html_tag( 'td',
            addPwField($password_form_name, null, 'onfocus="alreadyFocused=true;" style="background-color: #e5e5e5;
border: none;
border-radius: 3px;
-moz-border-radius: 3px;
-webkit-border-radius: 3px;
...
box-shadow: 0 0 3px 3px #663300;"').
            ...
            addHidden('just_logged_in', '1'),
                ...
                html_tag( 'tr',
                    html_tag( 'td',
                        '<center>'. addSubmit(_("Login"),'','style="position:absolute; top:410; left:610;background-color: #996633;box-shadow: 0 0 3px 3px #663300;border: none;border-radius: 180px;color: #f4f4f4;cursor: pointer;height: 80px;text-transform: uppercase;width: 80px;"') .'</center>',
                    'left' )
                ),
            '', $color[4], '' ) . '</center>',
        'center' )

...
if ($location_of_bar == 'right') {
    $output .= "<frameset FRAMEBORDER=0 FRAMESPACING=0 FRAMEBORDER=no BORDER=0 cols=\"*, 100px\" id=\"fs1\">\n";
}
else {
    $output .= "<frameset FRAMEBORDER=0 FRAMESPACING=0 FRAMEBORDER=no BORDER=0 cols=\"100px;, *\" id=\"fs1\">\n";
}
...
if ($location_of_bar == 'right') {
    $output .= "<frame src=\"$right_frame_url\" name=\"right\" style=\"background-color:transparent;margin:0px;padding:0px;border:0px;\" frameborder=\"0\">\n" .
               "<frame src=\"left_main.php\" name=\"left\" style=\"background-color:transparent;margin:0px;padding:0px;border:0px;\" frameborder=\"0\">\n";
}
else {
    $output .= "<frame src=\"left_main.php\" name=\"left\" style=\"background-color:transparent;margin:0px;padding:0px;border:0px;\" frameborder=\"0\">\n".
               "<frame src=\"$right_frame_url\" name=\"right\" style=\"background-color:transparent;margin:0px;padding:0px;border:0px;\" frameborder=\"0\">\n";
}

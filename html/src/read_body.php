...
function formatEnvheader($mailbox, $passed_id, $passed_ent_id, $message,
    ...
    $s  = '<table width="100%" cellpadding="0" cellspacing="2" border="0"';
         ' cellspacing="0" border="0" align="center" style="">'."\n";
    $s .= ' align="center" bgcolor="'.$color[0].'" style="margin-top:-5px;padding-bottom:5px;background-color:rgba(0,0,0,0.1);border-bottom:solid 2px #000;">';
...
function formatMenubar($mailbox, $passed_id, $passed_ent_id, $message, $mbx_response) {
    ...
    $s = '<table width="100%" cellpadding="3" cellspacing="0" align="center"'.
         ' border="0" bgcolor="'.$color[9].'" style="background-color:rgba(0,0,0,0.2);margin-top:-18px;"><tr>' .
...
echo html_tag( 'table' ,'' , 'left', '', 'cellpadding="1" cellspacing="5" border="0" style="padding-top:10px;border: solid 2px #000;border-radius:5px; background-color:rgba(0,0,0,0.2); width:90%;margin-left:5%;margin-top:-7px;"' );
echo '              <tr>' . html_tag( 'td', ''. $messagebody."\n", 'left')
                        . '</tr>';
echo '            </table>';
echo '          </td></tr>';
echo '        </table></td></tr>';

...
displayPageHeader($color, "Folders");
...
echo html_tag( 'table', '', 'center', '', 'width="70%" cellpadding="4" cellspacing="0" border="0"' ) .
     ...
     "<tt><select name=\"subfolder\" style=\"height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;\">\n";
...
echo "<input type=\"submit\" value=\""._("Create")."\" style=\"margin-top:10px;border-radius:7px;border:2px solid ;height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;\" />\n";
echo "</form></td></tr>\n";
...
if (count($skip_folders) < count($boxes)) {
    echo addForm('folders_rename_getname.php')
       . "<tt><select name=\"old\" style=\"height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;\">\n"
    ...
    echo "</select></tt>\n".
         ...
         _("Rename").
         "\" style=\"margin-top:10px;border-radius:7px;border:2px solid ;height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;\"/>\n".
         "</form></td></tr>\n";
} else {
...
if (count($skip_folders) < count($boxes)) {
    echo addForm('folders_delete.php')
       . "<tt><select name=\"mailbox\"style=\"height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;\">\n"
       . '         <option value="">[ ' . _("Select a folder") . " ]</option>\n";
...
if (count($skip_folders) < count($boxes)) {
    echo addForm('folders_subscribe.php?method=unsub', 'post', '', '', '', '', TRUE)
       . "<tt><select name=\"mailbox[]\" style=\"background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;\"multiple=\"multiple\" size=\"8\">\n";

...
if (isset($composenew) && $composenew) {
    ...
    displayPageHeader($color, "Search", "comp_in_new('$comp_uri');", false);
} else {
    displayPageHeader($color, "Search");
}
...
echo html_tag( 'div', '<b>' . _("Current Search") . '</b>', 'left' ) . "\n"
   ...
   . html_tag( 'tr' )
   . html_tag( 'td', '', 'left' )
   . '<select name="mailbox" style="height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;">'
...
echo html_tag( 'td', '<input type="text" size="35" name="what" style="border:1px groove black;border-radius:5px;width:480px;padding-left:5px;height:25px;font-size:15px;background-color:rgba(0,0,0,0.2);" value="' . $what_disp . '" />' . "\n", 'center' )
     . html_tag( 'td', '', 'right'   )
     . "<select name=\"where\" style=\"height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;border-radius:5px;;border:solid 2px #000;margin-right:10px;margin-left:10px;\">";
...
echo "         </select>\n" .
     "        </td>\n".
     html_tag( 'td', '<input type="submit" style="margin-top:px;border-radius:7px;border:2px solid ;height:30px;background-color:rgba(0,0,0,0.2);font-weight:bold;" name="submit" value="' . _("Search") . '" />' . "\n", 'center', '', 'colspan="3"' ) .
     "     </tr>\n".
     "   </table>\n".
     "</form>\n";

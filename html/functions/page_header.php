...
function makeInternalLink($path, $text, $target='') {
    ...
    return '<a style="text-decoration:none;font-size:17.5px;font-weight:bold" href="'.$base_uri.$path.'"'.$target.'>'.$text.'</a>';
}
...
function displayPageHeader($color, $mailbox, $xtra='', $session=false) {
    ...
    echo "<body background=\"../images/bg.jpg\" style=\"background-size:100% 100%;margin:0px;\"text=\"$color[8]\" bgcolor=\"$color[4]\" link=\"$color[7]\" vlink=\"$color[7]\" alink=\"$color[7]\" $onload>\n\n";
    ...
    echo "<a name=\"pagetop\"></a>\n"
        . html_tag('img src="../images/logo.png" style="height:150px;width:30%; margin-left:35%; margin-bottom:30px; margin-top:30px;"')  
        . html_tag( 'table', '', '', $color[4], 'style="height:80px;border-bottom:solid 3px #000;" border="0" width="100%" cellspacing="0" cellpadding="2"' ) ."\n"
        . html_tag( 'tr style="background-color:rgba(0,0,0,0.2);"', '', '', $color[9] ) ."\n"
        . html_tag( 'td style="height:60px;"', '', '' ) ."\n";
    
    if ( $shortBoxName <> '' && strtolower( $shortBoxName ) <> 'none' ) {
        echo '<center style="margin:auto;font-size:20px;"> ' . _("") . "<b style='font-size:28px;   '>$shortBoxName&nbsp;</b></center>\n";
        
    } else {
        echo '&nbsp;';
    }
    echo  "    </td>\n"
        . html_tag( 'td style="position:absolute;top:30px;right:50px;border-radius:7px;border:2px solid ;background-color:rgba(0,0,0,0.1);font-weight:bold;padding:3px;"', '', '' ) ."<b>\n";
    displayInternalLink ('src/signout.php', _("Sign Out"), $frame_top);
    echo "</b></td>\n"
        . "   </tr>\n"
        . html_tag( 'tr style="height:40px; width:100%;text-align:center;background-color:rgba(0,0,0,0.4);"', '', '', $color[4] ) ."\n"
        . ($hide_sm_attributions ? html_tag( 'td style="width:100%" cellspacing="1" ', '', '', '', '' )
                                 : html_tag( 'td', '', '' ) )
        . "\n";
    ...
    displayInternalLink ('src/about.php', _("About"));
    echo "&nbsp;&nbsp;\n";
    ...
    if (!$hide_sm_attributions)
    {
        ...
        echo '<a style="text-decoration:none;font-weight:bold;font-size:20px; position:absolute; top:12px;right:150px;"href="'.$provider_uri.'" target="_blank">'.$provider_name.'</a>';
        echo "</td>\n";
    }
    echo "   </tr>\n".
        "</table><br>\n\n";
...
function compose_Header($color, $mailbox) {
    ...
    */
    ...
    echo "<body background=\"../images/bg.jpg\" text=\"$color[8]\" bgcolor=\"$color[4]\" link=\"$color[7]\" vlink=\"$color[7]\" alink=\"$color[7]\" $onload>\n\n";
}
